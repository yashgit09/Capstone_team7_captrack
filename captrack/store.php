...
<html lang="en" dir="ltr">
    ...
    ?>            
						...
						$sql22 = $conn->prepare("SELECT * FROM products order by id desc");
						$sql22->execute();  
								...
								<div class="card user-pro-list overflow-hidden">
									<div class="">
										<div class="user-pic text-center">
											<img height="200" width="280" src="images/<?php echo $data22->image; ?>">									
										</div>
									</div>									
								</div>
								<div class="pro-user mt-3 text-center">
												<h5 class="pro-user-username text-dark mb-1 fs-16"><?php echo $data22->product; ?></h5>
												<h6 class="pro-user-desc text-muted fs-12"><?php echo $data22->price; ?> pts</h6>				
												<div style="padding: 10px" class="btn-list">
													<a href="checkout.php?product=<?php echo $data22->product; ?>" class="btn btn-primary mt-3">Buy</a>
												</div>
											</div>
							</div>
