...
if(isset($_SESSION['id']))
{
	...
	<body class="app sidebar-mini" id="index1">
      ...
      //$id=$_GET['id'];
						...
						$sql21 = $conn->prepare("SELECT * FROM registration where employee_id='".$result2->manager."'");
						$sql21->execute();
						$result21 = $sql21->fetch(PDO::FETCH_OBJ);

                        
						$sql22 = $conn->prepare("SELECT * FROM registration where manager='".$result2->employee_id."'");
						$sql22->execute();  
						$result22 = $sql22->fetchAll(PDO::FETCH_OBJ);
						$name = [];
						foreach($result22 as $data22)
						{ 
							$name[]=$data22->fname;
						}
						if(!is_null($name)){
											...
											<table class="table mb-0">
												<tbody>
													<tr>
														...
														<td class="py-2 px-0"><?php echo $result2->fname; ?> <?php echo $result2->lname; ?></td>
													</tr>
													...
													<tr>
														...
														<td class="py-2 px-0"><?php echo $result2->email; ?></td>
													</tr>
													<tr>
														<td class="py-2 px-0">
															<span class="font-weight-semibold w-50">Phone </span>
														</td>
														<td class="py-2 px-0"><?php echo $result2->phone; ?></td>
													</tr>
												</tbody>
											</table>
										</div>
										...
										<div class="tab-content">
											<div class="tab-pane show active" id="about">
												<div class="card-body">
													...
													<h5 class="font-weight-semibold">My Points</h5>
													<div class="main-profile-bio mb-0">
														<p><?php echo $result2->points; ?>
													</p>
												</div>
											</div>
												...
												<div class="main-profile-contact-list d-lg-flex">
													...
													<div class="media">
														...
														<div class="media-body">
															...
															<div class="font-weight-semibold">
																<?php echo $result2->present_address; ?>
															</div>
														</div>
													</div>
											...
											<div class="card-body border-top">
												<h5 class="font-weight-semibold">Office Details</h5>
												<div class="main-profile-contact-list d-lg-flex">
														...
														<table class="table mb-0">
															<tbody>
																<tr>
																	...
																	<td class="py-2 px-0"><?php echo $result2->designation; ?></td>
																</tr>
																
																
																<tr>
																	<td class="py-2 px-0">
																		<span class="font-weight-semibold w-50">Manager </span>
																	</td>
																	<td class="py-2 px-0"><?php echo $result21->fname; ?></td>
																</tr>
																<tr>
																	<td class="py-2 px-0">
																		<span class="font-weight-semibold w-50">Reportees </span>
																	</td>
																	<td class="py-2 px-0"><?php if($names==''){echo 'None';} else{echo$names;}   ?></td>
																</tr>
															</tbody>
														</table>
													</div>
