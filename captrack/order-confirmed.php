...
<html lang="en" dir="ltr">
    ...
    <?php
      ...
      $sql22 = $conn->prepare("SELECT * FROM orders where id='".$_GET['id']."'");
      $sql22->execute();
      $result22 = $sql22->fetch(PDO::FETCH_OBJ);                
    ?>            
						...
						<div class="page-header d-lg-flex d-block">
							...
							<div class="page-leftheader">
								<h4 class="page-title">Your Order Confirmed!  </h4>
							</div>
                        ...
                        <div class="page-left">
								<h3 class="">Hi <?php echo $result2->fname; ?>,<br> Your order has been confirmed. </h3>
							</div>
													...
													<div class="main-profile-contact-list d-lg-flex">
														...
														<div class="media mr-4">														
															<div class="media-body">
																<h5 class="pro-user-username text-dark mb-1 fs-16"><?php echo $result22->product; ?></h5>
