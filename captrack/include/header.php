 		...
 		<div class="d-flex">
 			...
 			<div class="d-flex order-lg-2 my-auto ml-auto">
 				...
 				<div class="dropdown profile-dropdown">
 					<a href="profile.php" class="nav-link pr-1 pl-0 leading-none" data-toggle="dropdown">
 						<span>
 					...
 					<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
 						<div class="p-3 text-center border-bottom">
 							<a href="profile.php" class="text-center user pb-0 font-weight-bold"><?php echo $result2->fname; ?> <?php echo $result2->lname; ?></a>
 							<p class="text-center user-semi-title"><?php echo $result2->designation; ?></p>
 						</div>
