					...
					<div class="side-app">
						...
						<div class="page-header d-lg-flex d-block">
							...
							<div class="page-leftheader">
								<h4 class="page-title">Your Order Summary  </h4>
							</div>
									...
									<div class="main-profile-body">
										<div class="tab-content">
											<div class="tab-pane show active" id="about">
												...
												$sql221 = $conn->prepare("SELECT * FROM orders where employee_id='".$_SESSION['id']."' ");
												$sql221->execute();  
												$result221 = $sql221->fetchAll(PDO::FETCH_OBJ);
												foreach($result221 as $data221)
												{ 
													$sql21 = $conn->prepare("SELECT * FROM products where id='".$data221->product_id."'");
													$sql21->execute();
														...
														<div class="main-profile-contact-list d-lg-flex">
															...
															<div class="media mr-4">												
																<div class="media-body">
																	<h5 class="pro-user-username text-dark mb-1 fs-16"><?php echo $data221->product; ?></h5>	
																	<h5 class="pro-user-username text-dark mb-1 fs-16">Order Date: <?php echo $data221->order_date; ?></h5>
																</div>
															</div>
