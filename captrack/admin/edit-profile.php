...
$sql3 = $conn->prepare("SELECT * FROM adminlogin WHERE id='".$_SESSION['id']."'");
$sql3->execute();
...
$sql = $conn->prepare("UPDATE adminlogin SET fname =?,lname =?,mobileno =?,address =?,city =?,pincode =?,country =?,image =? where id='".$_SESSION['id']."'");
if($sql->execute([$fname,$lname,$phone,$address,$city,$zipcode,$country,$image]))
{

$_SESSION['upmsg1']="<div class='alert alert-success'><center>Update Your Profile Successfully.</center></div>";
}
}
										...
										<div class="row">
											...
											<div class="col-sm-6 col-md-6">
												<div class="form-group">
													...
													<input type="email" readonly="" class="form-control" placeholder="Email" name="email" value="<?php echo $result2->email; ?>">
												</div>
											</div>
											<div class="col-sm-6 col-md-6">
												<div class="form-group">
													<label class="form-label">Phone Number</label>
													<input type="number" class="form-control" placeholder="Number" name="phone" value="<?php echo $result2->mobileno; ?>">
												</div>
											</div>
											<div class="col-md-12">
												<div class="form-group">
													<label class="form-label">Address</label>
													<input type="text" class="form-control" placeholder="Home Address" name="address" value="<?php echo $result2->address; ?>">
												</div>
											</div>
											<div class="col-sm-6 col-md-4">
												<div class="form-group">
													<label class="form-label">City</label>
													<input type="text" class="form-control" placeholder="City" name="city" value="<?php echo $result2->city; ?>">
												</div>
											</div>
											<div class="col-sm-6 col-md-3">
												<div class="form-group">
													<label class="form-label">Postal Code</label>
													<input type="number" class="form-control" placeholder="ZIP Code" name="zipcode" value="<?php echo $result2->pincode; ?>">
												</div>
											</div>
											<div class="col-md-5">
												<div class="form-group">
													<label class="form-label">Country</label>
													<select class="form-control  select2" data-placeholder="Select Country" name="country">
														<option label="Select Country"></option>
														<option value="India" <?php if($result2->country=='India') { echo "selected";}?>>India</option>
														<option value="Canada" <?php if($result2->country=='Canada') { echo "selected";}?>>Canada</option>
														<option value="Usa" <?php if($result2->country=='Usa') { echo "selected";}?>>Usa</option>
														<option value="Afghanistan" <?php if($result2->country=='Afghanistan') { echo "selected";}?>>Afghanistan</option>
														<option value="Albania" <?php if($result2->country=='Albania') { echo "selected";}?>>Albania</option>
														<option value="China" <?php if($result2->country=='China') { echo "selected";}?>>China</option>
														<option value="Denmark" <?php if($result2->country=='Denmark') { echo "selected";}?>>Denmark</option>
														<option value="Finland" <?php if($result2->country=='Finland') { echo "selected";}?>>Finland</option>
														<option value="Kiribati" <?php if($result2->country=='Kiribati') { echo "selected";}?>>Kiribati</option>
														<option value="Kuwait" <?php if($result2->country=='Kuwait') { echo "selected";}?>>Kuwait</option>
														<option value="Mexico" <?php if($result2->country=='Mexico') { echo "selected";}?>>Mexico</option>
														<option value="Pakistan" <?php if($result2->country=='Pakistan') { echo "selected";}?>>Pakistan</option>													
													</select>
												</div>
											</div>
											<div class="col-md-12">
