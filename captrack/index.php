...
if(isset($_POST['submit']))
{
    ...
    $sth=$conn->prepare("SELECT * FROM registration where email='$email11' AND password='$password11' and status='Active'");
    $sth->execute();
    ...
    $_SESSION['signmsg']="<div class='alert alert-success'><center>Enter Valid Credentials.</center></div>";
}
  ob_flush();
}
...
<style>
  .blx{background:#fff; padding:20px; border-radius:50%}
  </style>
	</head>
		...
		<div class="page relative error-page3">
			<div class="row no-gutters">
				<div class="col-xl-6 h-100vh">
					<div class="cover-image h-100vhonmob" data-image-src="images/login3.jpg">
						<div class="container">
							<div class="customlogin-imgcontent">
								<img height="75" width="90" src="images/captrack.jpg" alt=""
								class="blx">
								<h2 class="mb-3 mt-1 fs-35 text-white"> Captrack</h2>
								<p class="text-white-50">We are providing services specially construction site like , helper, assistance , Deep industrial and offices cleaning assistance , etc.</p>
							</div>
						</div>
					</div>
				</div>
				<div class="col-xl-6 bg-white h-100vhonmob">
					<div class="container">
						
						<div class="customlogin-content">
						<?php
                            if (isset($_SESSION['signmsg'])) {
                            echo $_SESSION['signmsg'];
                        ...
                        <?php
                            if (isset($_SESSION['changmsg'])) {
                            echo $_SESSION['changmsg'];
                            
                            }
                            unset ($_SESSION["changmsg"]);
                            ?>`
							...
							<form class="card-body pt-3" id="login1" method="POST" autocomplete="off">
								<div class="form-group">
									...
									<input class="form-control" placeholder="Email Address" type="email" name="email" id="email">
								</div>
								<div class="form-group">
								...
								<div class="text-center mt-3">
									<p class="mb-2"><a href="admin/index.php">Admin Login</a></p>
